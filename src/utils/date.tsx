...
export const DD_MM_YY = (date_: string) => dayjs(new Date(safariDateFix(date_))).format("DD MMM,YYYY")

export const HH_MM = (date_: string) => dayjs(new Date(safariDateFix(date_))).format("HH:mm:a")
